...
public class EmployeeList extends Vector<Employee> {
        ...
        if (size() == 0) { // If there's no data in list
            ...
            try {
                ...
                for (Employee e : this) {
                    ...
                    pw.write(e.getCode() + "," + e.getName() + "," + e.getSalary());
                    pw.write("\n");
                }
                pw.close();
                fw.close();
        ...
        do {
            ...
            do {
                ...
                if (!newName.isEmpty()) { // If inputed name is not empty
                    ...
                    Utils.showTextAndRetype("[NAME] should not be empty!");
                }
            } while (true);
            ...
            do {
                ...
                try {
                    ...
                    if (newSalary < 0) { // If inputed salary is lower than zero
                        Utils.showTextAndRetype("[SALARY] should not be lower than zero!");
                    } else {
                        break;
                    }

                } catch (Exception e) {
                    Utils.showTextAndRetype("[SALARY] is not valid!");
                }
            } while (true);

            // Add data to List
            add(new Employee(newCode, newName, newSalary));
            ...
            if (this.size() > 0) { // If there're data in list
                do {
                    ...
                    if (newCode.matches("^E\\d{3}$")) {
                        ...
                        if (pos != -1) { // If that employee is existed
                            this.remove(pos);
                            Utils.showTextAndRetype("Remove successfully!");
                            break;
                        } else {
                ...
                Utils.showTextAndRetype("There is no data!");
            }
            ...
            do {
                ...
                try {
                    ...
                    if (newSalary < 0) { // If salary is lower than zero
                        Utils.showTextAndRetype("New salary must not be lower than zero!");
                    ...
                    Utils.showTextAndRetype("New salary is not valid!");
                }
            } while (true);
    ...
    public void listEmployee() {
        ...
        System.out.println("║CODE" + Utils.printChar(' ', maxWidthCol1 - 4) + "║NAME"
                + Utils.printChar(' ', maxWidthCol2 - 4) + "║SALARY" + Utils.printChar(' ', maxWidthCol3 - 6) + "║");
        ...
        for (Employee e : this) {
            ...
            System.out.println("║" + code + Utils.printChar(' ', maxWidthCol1 - code.length()) + "║" + name
                    + Utils.printChar(' ', maxWidthCol2 - name.length()) + "║" + salary
                    + Utils.printChar(' ', maxWidthCol3 - String.valueOf(salary).length()) + "║");
        }
        System.out.println("╚" + Utils.printChar('═', maxWidthCol1 + maxWidthCol2 + maxWidthCol3 + 2) + "╝");
